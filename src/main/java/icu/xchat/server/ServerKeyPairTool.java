 ...
 * @author shouchen
 */
public final class ServerKeyPairTool {
    private static final Logger LOGGER = LoggerFactory.getLogger(ServerKeyPairTool.class);
    ...
    private static void genRsaKeypair(int keypairSize) throws NoSuchAlgorithmException {
        ...
        byte[] buf = CompressionUtils.compress(encoder.encode(bsonObject));
    ...
    public static synchronized void loadKeyPair(String keypairType) throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, DataFormatException {
        ...
        byte[] data = CompressionUtils.deCompress(outputStream.toByteArray());
